### Нуклеосома, линкеры 30 п.н., повторность 1 - траекторий молекулярной динамики нуклеосомы с линкерами ДНК 30 п.н. в симметричной конформации (PDB ID 3LZ0)
...
<script>
  var pdb="linker30_2run_sym.pdb"
  var xtc="linker30_2run_sym.xtc"
  var trjstep = 2;
