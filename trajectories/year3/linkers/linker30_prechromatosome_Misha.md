### Нуклеосома, суперскрученная, повторность 2 - траекторий молекулярной динамики нуклеосомы с линкерами ДНК 30 п.н. в суперскрученной стартовой конформации (PDB ID 3LZ0)
...
<script>
  var pdb="linker30_prechromatosome_Misha.pdb"
  var xtc="linker30_prechromatosome_Misha.xtc"
  var trjstep = 2;
