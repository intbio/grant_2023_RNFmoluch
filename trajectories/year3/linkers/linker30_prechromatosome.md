### Нуклеосома, суперскрученная, повторность 1 - траекторий молекулярной динамики нуклеосомы с линкерами ДНК 30 п.н. в суперскрученной стартовой конформации (PDB ID 3LZ0)
...
<script>
  var pdb="linker30_prechromatosome.pdb"
  var xtc="linker30_prechromatosome.xtc"
  var trjstep = 2;
