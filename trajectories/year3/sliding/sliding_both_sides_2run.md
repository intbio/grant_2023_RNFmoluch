...
<script>
  var pdb="sliding_both_sides_2run.pdb"
  var xtc="sliding_both_sides_2run.xtc"
  var trjstep = 2;
  $(document).ready(function() {
    ...
    <figure>
      <img src="relative_twist_sliding_both_sides_2run.png" alt="reltwist" style="width:100%">
    </figure>
        <figure>
      <img src="angles_sliding_both_sides_2run.png" alt="angles" style="width:88%">
    </figure>
  </body>
</html>
