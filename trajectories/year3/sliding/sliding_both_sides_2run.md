### SHL -2 и +2, нижние цепи, повторность 2 - траектория молекулярной динамики нуклеосомы с управляемым формированием торсионного дефекта (PDB ID 3LZ0)
[Назад](http://intbio.github.io/grant_2023_RNFmoluch/year3.html)
...
<script>
  var pdb="sliding_both_sides_run2.pdb"
  var xtc="sliding_both_sides_run2.xtc"
  var trjstep = 2;
  $(document).ready(function() {
	...
	["pink", "39 and HIS"],
	  ...
	  window.nucl_cartoon_mov = nucl.addRepresentation('cartoon', {
        "sele": "nucleic and (nucleic and 41-61)",
        "color": 'magenta',
        "aspectRatio": aspectRatio,
        "radius": radius,
        "radiusSegments": 1.1,
    ...
    <figure>
      <img src="relative_twist_sliding_both_sides_run2.png" alt="reltwist" style="width:100%">
    </figure>
        <figure>
      <img src="angles_sliding_both_sides_run2.png" alt="angles" style="width:88%">
    </figure>
  </body>
</html>
