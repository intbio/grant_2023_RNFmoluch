### SHL +2, нижняя цепь, повторность 1 - траекторий молекулярной динамики нуклеосомы с управляемым формированием торсионного дефекта (PDB ID 3LZ0)
...
<script>
  var pdb="sliding_I.pdb"
  var xtc="sliding_I.xtc"
  var trjstep = 2;
