...
<script>
  var pdb="sliding_J_run3.pdb"
  var xtc="sliding_J_run3.xtc"
  var trjstep = 2;
  $(document).ready(function() {
    ...
    <figure>
      <img src="relative_twist_sliding_J_run3.png" alt="reltwist" style="width:100%">
    </figure>
        <figure>
      <img src="angles_sliding_J_run3.png" alt="angles" style="width:88%">
    </figure>
  </body>
</html>
