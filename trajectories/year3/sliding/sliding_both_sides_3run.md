### SHL -2 и +2, нижние цепи, повторность 3 - траектория молекулярной динамики нуклеосомы с управляемым формированием торсионного дефекта (PDB ID 3LZ0)
...
<script>
  var pdb="sliding_both_sides_3run.pdb"
  var xtc="sliding_both_sides_3run.xtc"
  var trjstep = 2;
  $(document).ready(function() {
    ...
    <figure>
      <img src="relative_twist_sliding_both_sides_3run.png" alt="reltwist" style="width:100%">
    </figure>
        <figure>
      <img src="angles_sliding_both_sides_3run.png" alt="angles" style="width:88%">
    </figure>
  </body>
</html>
