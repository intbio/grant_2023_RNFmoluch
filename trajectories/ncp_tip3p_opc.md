### НУКЛ<sub>TIP3P, CUFIX</sub> - траектория МД нуклеосомы в окружении воды модели TIP3P в силовом поле Amber ff14SB + ParmBSC1 коррекции + CUFIX ионы 
...
<script>
  var pdb="1kx5_tip3p.pdb"
  var xtc="1kx5_tip3p_filtered.xtc"
