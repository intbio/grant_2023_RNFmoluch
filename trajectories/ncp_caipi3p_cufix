### НУКЛ<sub>CAIPi3P, CUFIX</sub> - траектория МД нуклеосомы в окружении воды модели CAIPi3P в силовом поле Amber ff14SB + ParmBSC1 коррекции + CUFIX ионы 
...
<script>
  var pdb="_1kx5_in_CAIPi3P_water_cufix_amber_nrf.pdb"
  var xtc="_1kx5_in_CAIPi3P_water_cufix_amber_filtered.xtc"
