### NUCL<sup>15</sup><sub>run 1</sub> - траектория МД нуклеосомы с линкерами ДНК длиной 15 пар нуклеотидов (PDB ID 3LZ0, полноразмерные гистоновые хвосты), повторность 1
...
<script>
  var pdb="linker15.pdb"
  var xtc="linker15.xtc"
