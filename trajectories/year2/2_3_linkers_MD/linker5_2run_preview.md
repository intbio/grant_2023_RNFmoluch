### NUCL<sup>5</sup><sub>run 2</sub> - траектория МД нуклеосомы с линкерами ДНК длиной 5 пар нуклеотидов (PDB ID 3LZ0, полноразмерные гистоновые хвосты), повторность 2
...
<script>
  var pdb="linker5_2run.pdb"
  var xtc="linker5_2run.xtc"
