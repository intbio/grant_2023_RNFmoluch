### NUCL<sup>25</sup><sub>run 2</sub> - траектория МД нуклеосомы с линкерами ДНК длиной 25 пар нуклеотидов (PDB ID 3LZ0, полноразмерные гистоновые хвосты), повторность 2
...
<script>
  var pdb="linker25_2run.pdb"
  var xtc="linker25_2run.xtc"
