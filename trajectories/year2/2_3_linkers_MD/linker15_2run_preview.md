### NUCL<sup>15</sup><sub>run 2</sub> - траектория МД нуклеосомы с линкерами ДНК длиной 15 пар нуклеотидов (PDB ID 3LZ0, полноразмерные гистоновые хвосты), повторность 2
