### NUCL<sup>30</sup><sub>run 2</sub> - траектория МД нуклеосомы с линкерами ДНК длиной 30 пар нуклеотидов (PDB ID 3LZ0, полноразмерные гистоновые хвосты), повторность 2
...
<script>
  var pdb="linker30_2run.pdb"
  var xtc="linker30_2run.xtc"
