### mrt_50_1 - траектория МД нуклеосомы в комплексе с SOX2 на позиции 50 (модель, перестроенный хвост Sox2), повторность 1
...
<script>
  var pdb="mrt_50_1.pdb"
  var xtc="mrt_50_1.xtc"
