### f_50_2 - траектория МД нуклеосомы с сайтом Sox2 на позиции 50, повторность 2
...
<script>
  ...
  $(document).ready(function() {
    ...
    $('input[type=checkbox][name=sox_site_check]').on('change', toggle_sox_site_visibility);
    ...
    <br>
    <input class="form-check-input " type="checkbox" name="sox_site_check" value="" id="sox_site_check">
    <label class="form-check-label " for="sox_site_check">
      Show Sox2 binding motif
    </label>
