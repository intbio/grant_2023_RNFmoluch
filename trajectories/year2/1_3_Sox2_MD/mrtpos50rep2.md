### mrt_50_2 - траектория МД нуклеосомы в комплексе с SOX2 на позиции 50 (модель, перестроенный хвост Sox2), повторность 2
...
<script>
  var pdb="mrt_50_2.pdb"
  var xtc="mrt_50_2.xtc"
