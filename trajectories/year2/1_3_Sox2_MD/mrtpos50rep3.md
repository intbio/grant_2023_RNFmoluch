### mrt_50_3 - траектория МД нуклеосомы в комплексе с SOX2 на позиции 50 (модель, перестроенный хвост Sox2), повторность 3
...
<script>
  var pdb="mrt_50_3.pdb"
  var xtc="mrt_50_3.xtc"
